import random
class Car:
    def __init__(self, rekisteritunnus, top_speed):
        ...
        self.travel_hours = 0
    def info(self):
        print("Auton rekisteri numero", self.rekisteritunnus, ","
              , self.top_speed,"km/h maksiminopeus,", self.speed,"km/h nopeus,",
              self.travel_distance, "km kuljettu matka", self.travel_hours, "tuntia ajettu")
